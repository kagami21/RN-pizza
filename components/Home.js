...
export default Home = ({navigation}) => {
  ...
  const renderCategoryItem = ({item}) => {
    return(
      <View style={[styles.categoryItemWrapper, { backgroundColor: item.selected ? colors.primary : colors.white, marginLeft: item.id == 1 ? 20 : 0 }]}>
        ...
        <View style={[styles.categorySelectWrapper, { backgroundColor: item.selected ? colors.white : colors.secondary}]}>
          <Feather name="chevron-right" size={10} style={styles.categorySelection} color={item.selected ? colors.black : colors.white}/>
        </View>
      </View>
    )
  }
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={styles.headerWrapper}>
        ...
        />
        <Feather name="home" size={24} color={colors.textDark}/>
      </View>
